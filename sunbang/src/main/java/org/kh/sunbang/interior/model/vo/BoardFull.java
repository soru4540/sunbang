...
public class BoardFull implements Serializable{
	...
	public BoardFull(int board_no, String board_type, String space, String housing_type, String category1,
			...
			int post_no, String post_keyword, String post_data, String post_contents, int marker_no,
			String product_image, int cordi_x, int cordi_y, String product_url, int user_no, String user_profile,
	...
	public String toString() {
		return "BoardFull [board_no=" + board_no + ", board_type=" + board_type + ", space=" + space + ", housing_type="
				...
				+ ", marker_no=" + marker_no + ", product_image=" + product_image + ", cordi_x=" + cordi_x
				+ ", cordi_y=" + cordi_y + ", product_url=" + product_url + ", user_no=" + user_no + ", user_profile="
				+ user_profile + ", user_id=" + user_id + ", nickname=" + nickname + ", user_name=" + user_name
				+ ", like_count=" + like_count + ", follow_count=" + follow_count + "]";
	}
