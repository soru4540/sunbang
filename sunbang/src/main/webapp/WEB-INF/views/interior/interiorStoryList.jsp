				...
				<div class="row">
					<div class="col-md-3">					 				
						    <div id="fix_con">													
								...
								<br>
								<a href="istory.do?user_no=${loginUser.user_no}&follower_no=${loginUser.user_no}" class="font-weight-bold">${fuser.nickname}<br>${fuser.user_id } ${fuser.user_name }</a> <br><a href="ifollowlist.do?user_no=1"><span
