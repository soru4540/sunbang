...
5. 광고를 위한 매물이 등록되어 있을 경우, 탈퇴 시 모든 정보는 삭제 처리됩니다.</pre>
		<div class="form-group" style="font-size:13px;"><select class="form-control">
		...
		<div class="form-group"><textarea class="form-control" rows="3" placeholder="다른 사유가 있으시면 적어주십시오" style="resize:none;"></textarea></div></div>
...
<div class="row" style="width:800px; margin:auto auto;">
	...
	<div class="col-md-6">
		...
		<div class="form-group"><label>대표 전화번호</label><span class="d-flex"><select class="form-control mr-2"></select><input type="number" class="form-control mr-2"><input type="number" class="form-control"></span></div></div>
	<div class="col-md-6">
		<div class="form-group"><label>프로필</label><button class="btn btn-block btn-light"">이미지 업로드</button></div>
		<div class="form-group"><label>아이디</label><input type="text" class="form-control"></div>
		<div class="form-group"><label>닉네임</label><input type="text" class="form-control"></div>
		...
		<div class="form-group"><label>휴대폰번호</label><span class="d-flex"><span  class="d-flex" style="width:calc(100% - 90px);"><select class="form-control mr-2"></select><input type="number" class="form-control mr-2"><input type="number" class="form-control"></span><button class="btn btn-lgreen" style="width:85px; margin-left:8px;">인증</button></span></div>
		<div class="form-group"><label>비밀번호<small>(보안등급: 높음)</small></label><input type="password" class="form-control"></div>
		<div class="form-group"><label>비밀번호 확인</label><input type="password" class="form-control"></div></div>
