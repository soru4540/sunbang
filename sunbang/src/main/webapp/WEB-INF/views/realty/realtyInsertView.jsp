...
<div class="container" style="font-family: a고딕12;">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="row"> <!-- 매물 등록 -->
				<div class="col-md-12">
					<br><h4 class="text-center">매물 등록</h4><hr>
					<div class="row">
						<div class="col-md-12">
							<div id="sh_pi">
										일반 회원은 최대 5개의 매물을 내놓을 수 있습니다.<br>
...
<script>
    ...
    var marker = new daum.maps.Marker({
        ...
        map: map
			...
			<br><br>
			<div class="row" id="sh_tradei"> <!-- 거래 정보 -->
				<div class="col-md-12">
						<h6>거래 정보</h6><hr>				
					<div class="row">
						<div class="col-md-2">
			...
			<br><br>
			<div class="row" id="sh_basici"> <!-- 기본 정보 -->
				<div class="col-md-12">
							<h6>기본 정보</h6><hr>
					<div class="row">
						<div class="col-md-2">
			...
			<br><br>
			<div class="row" id="sh_additioni"> <!-- 추가 정보 -->
				<div class="col-md-12">
					<h6>추가 정보</h6><hr>
					<div class="row">
						<div class="col-md-2">
			...
			<br><br>
			<div class="row" id="sh_detaili"> <!-- 상세 정보 -->
				<div class="col-md-12">
					<h6>상세 정보</h6><hr>				
					<div class="row">
						<div class="col-md-2">
