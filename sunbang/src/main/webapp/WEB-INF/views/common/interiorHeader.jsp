		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav mr-auto"
				...
				<li class="nav-item"><a class="nav-link"
					href="inlistselect.do">뉴스피드</a></li>
				<li class="nav-item"><a class="nav-link"
					href="#">글쓰기</a></li>
				<li class="nav-item"><a class="nav-link"
				...
				<li class="nav-item" id="js_pheader_user"><c:if test="true">
						...
						<div class="dropdown-menu dropdown-menu-right dropdown-default"
							...
							<a class="dropdown-item" href="userupdateview.do"><i class="fas fa-user-edit"></i>
								내 정보 수정</a> <a class="dropdown-item" href="mycheckview.do"><i
								class="far fa-check-circle"></i> 찜보기</a> <a class="dropdown-item"
								href="mylikeview.do"><i class="far fa-heart"></i> 좋아요</a> <a
								class="dropdown-item" href="mychatview.do"><i class="far fa-comments"></i>
