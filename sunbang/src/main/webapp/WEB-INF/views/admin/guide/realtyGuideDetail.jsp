	...
	<div class="container" style="min-height: 960px; margin-top: 60px;">
		<div class="row">
			<div class="col-sm-9">
				<p>${guide.category }</p>
				<br>
				<h4 id="js_pgdetail_h4">${guide.title }</h4>
				<hr id="js_pgdetail_hr">
				<div class="box_introduce">
					<p id="js_pgdetail_pre">${guide.contents}</p>
				</div>
			</div>
			<div class="col-sm-3">
				<div class="fix_con">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" onclick="location.href='agdelete.do?guide_system=${guide.guide_system }&guide_no=${guide.guide_no}'">삭제</button>
				</div>
			</div>
		</div>
	</div>
