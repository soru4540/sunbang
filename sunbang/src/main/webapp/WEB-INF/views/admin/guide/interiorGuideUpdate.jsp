...
<body>
	...
	<div class="container" id="js_iginsert_con">
		<div class="row">
			<p id="js_iginsert_title">인테리어 가이드 수정</p>
		</div>
		<form id="gupdateform" name="gupdateform" method="POST" enctype="multipart/form-data">
			<div class="form-group">
				<input type="hidden" id="guide_system" name="guide_system" value="interior">
				<input type="hidden" id="guide_no" name="guide_no" value="${guide.guide_no }">
				<label for="category">카테고리 선택</label> <select
					class="form-control " id="category" disabled >
			...
			<div class="form-group">
				...
				<label for="file">첨부파일 </label>${guide.thumbnail }<input type="file"
