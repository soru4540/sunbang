...
<script type="text/javascript">
	function openView(){
		var realty_no =${report.contents_no };
		var popupX = (window.screen.width/2) - (1200/2);
		var popupY= (window.screen.height/2) - (1000/2);
		window.open('rdetail.do?realty_no='+realty_no, 'View',
				'width=1200,height=900,left='+ popupX + ', top='+ popupY + ', screenX='+ popupX + ', screenY= '+ popupY+',scrollbars=no');
	}
...
<body>
	<div class="container" style="height: 100%;">
		<div>
			<h4 align="center" id="js_rpdetail_h4">부동산 신고글 상세</h4>
		</div>
		<div id="js_rpdetail_table">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">매물번호</label>
				<div class="col-sm">
			...
			<div class="form-group row">
				...
				<div class="col-sm">
					<input type="text" class="form-control" id="handle_date" disabled
						style="background-color: white;" value="${report.handle_date }">
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">매물상태</label>
				<div class="col-sm">
					<input type="text" class="form-control" id="contents_status" disabled
			...
			<div class="form-group row">
				<div align="right" style="width: 70%;">
					<c:if test="${report.report_status != 2}">
					<button class="btn btn-primary" onclick="update(2)">처리완료</button>&nbsp;&nbsp;
						<button class="btn btn-danger" data-toggle="modal" data-target="#delete">검수</button>
					</c:if>
					<!-- Modal -->
							...
							<div class="modal-dialog modal-dialog-centered" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">매물 정보 검수 안내
											메세지</h5>
									</div>
									<div class="modal-body" style="text-align:center;">정말 이 매물의 상태를 검수중으로 바꾸시겠습니까?</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-secondary" data-dismiss="modal">취소</button>
										<button type="button" class="btn btn-primary" onclick="update(1)">확인</button>
									</div>
								</div>
							</div>
						</div>
